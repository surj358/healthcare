...
export function UserDashboard() {
    ...
    <div>
        ...
        <h1 className="text-3xl font-semibold text-center mx-auto mt-10">{cookies['username']} -Welcome to User DashBoard</h1>
        <button className="bg-red-600 px-4 mt-10 shadow-lg hover:scale-105 duration-300 text-sm font-bold text-white rounded-md" onClick={handleSignOut}>Sign out</button>

        </div>
        {/* userprofile------------------.>>>>>>>>>>>>>.         */}
        {/* <div className="flex justify-center gap-10 items-center my-[150px]">
